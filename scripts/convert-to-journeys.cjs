...
// page → [glow tint, flip order, finale board label]; every page gets its own
const PAGES = {
  'web-apps':             ['99,102,241', ['y', 'x', '-y', 'zoom', '-x', 'y', 'x'], 'YOUR WEB APP'],
  'saas':                 ['16,185,129', ['x', '-y', 'zoom', 'y', '-x', 'x', 'y'], 'YOUR SAAS'],
  'cloud':                ['56,189,248', ['-y', 'zoom', 'x', '-x', 'y', 'zoom', 'x'], 'YOUR CLOUD SETUP'],
  'personalized-ai':      ['160,107,255', ['zoom', 'y', '-x', 'x', '-y', 'y', 'zoom'], 'YOUR AI ASSISTANT'],
  'launch-a-new-product': ['76,175,80', ['x', 'y', 'zoom', '-y', 'x', 'y'], 'YOUR PRODUCT'],
  'modernize-an-app':     ['236,72,153', ['-x', 'y', 'x', 'zoom', '-y', 'x'], 'YOUR APP'],
  'replace-spreadsheets': ['20,184,166', ['y', '-x', 'zoom', 'x', '-y', 'y'], 'YOUR NEW TOOL'],
  'secure-your-software': ['239,68,68', ['zoom', '-y', 'x', 'y', '-x', 'zoom'], 'YOUR SOFTWARE'],
  'move-to-the-cloud':    ['14,165,233', ['-y', 'x', 'y', 'zoom', '-x', 'x'], 'YOUR SERVERS'],
  'ongoing-support':      ['59,130,246', ['x', 'zoom', '-y', 'y', '-x', 'x'], 'YOUR SOFTWARE'],
};
...
function journey(slug, d, [tint, flips, label]) {
  const scenes = [];
  ...
  return `    <!-- ============ ${d.product} journey ============
    ...
    <section class="sj sj-product" data-journey style="--sj-tint:${tint}" aria-labelledby="pageTitle">
      <div class="sj-stage">
